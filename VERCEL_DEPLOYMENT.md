# HERO MARKET - JSONBin.io + Vercel Deployment Guide

Panduan lengkap untuk deploy Hero Market ke Vercel dengan JSONBin.io sebagai database.
...
NODE_ENV=production
PORT=3000
SESSION_SECRET=hero-market-secret-key-2025-change-this
...
SUPPORT_EMAIL=support@heromarket.com

# Site Config
SITE_NAME=HERO MARKET
...
git remote add origin https://github.com/username/heromarket.git
...
- Project name: `hero-market-backend` (atau nama lain)
...
- URL akan berupa: `https://hero-market-backend.vercel.app`
...
const API_BASE = 'https://hero-market-backend.vercel.app';
// atau
